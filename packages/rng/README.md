...
│ Math.random() †                                      │     0.31 │    327,796,845 │  fastest │
...
│ Math.random()  loop †                                │     1.93 │     51,699,251 │    3.76x │
...
│ crypto.getRandomValues()  [bulk fill] †              │     2.04 │     48,952,514 │    3.97x │
└──────────────────────────────────────────────────────┴──────────┴────────────────┴──────────┘
...
│ @arkv/rng  · xoroshiro128+  [batch]                  │     0.42 │    240,644,349 │    2.02x │
...
│ Math.random() †                                      │     0.21 │    485,637,278 │  fastest │
...
│ Math.random()  + floor †                             │     0.37 │    271,130,560 │  fastest │
